...
class AuthViewModel extends StateNotifier<AsyncValue<UserModel?>> {
  ...
  Future<void> register(
      String email, String userName, String mobile, String avatar, BuildContext context) async {
    state = const AsyncValue.loading();
    final result = await repository.registerInfo(email, userName, mobile, avatar);
